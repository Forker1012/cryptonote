...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x3a931e7;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(1000000000000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "EverMore";
...
const int      RPC_DEFAULT_PORT                              = 47000;
